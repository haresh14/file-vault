...
struct CoreDataManagerTests {
    ...
    @Test func testPersistentContainer() async throws {
        ...
        #expect(manager.persistentContainer.name == "Keepshire", "Persistent container should be initialized with correct name")
        #expect(manager.persistentContainer.name == "Keepshire", "Container should have correct name")
    }
