...
| X8 | iPad | Folder tab uses a two-column split of **root** folders plus content. Nested-folder sidebar and iPad layouts for Gallery, Categories, Trash, Settings, and preview are deferred. Multiple scenes remain disabled. |
